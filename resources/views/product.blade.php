...
<head>
    ...
    <title>Catalog Product | Ellora Official</title>
...
<body data-bs-spy="scroll" data-bs-target="#navbar">
    ...
    <!-- Home -->
    <!-- Home -->
    <section id="home" class="d-flex align-items-center min-vh-100 jarak-produk" style="padding-top: 100px">
        <div class="container justify-content-center">
            <div class="row jarak-bawah">
